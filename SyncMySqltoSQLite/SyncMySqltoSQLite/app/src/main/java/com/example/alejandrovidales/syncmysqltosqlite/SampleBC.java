//service class to launch the syncronization when the SQlite is not sync with mainDB
...
public class SampleBC extends BroadcastReceiver {
    ...
    //DBController controller = new DBController(SampleBC.this);
    ...
    public void onReceive(final Context context, Intent intent) {
        ...
        client.post(url+"getdbrowcount.php",params ,new AsyncHttpResponseHandler() {
            @Override
            public void onSuccess(String response) {
                ...
                try {
                    ...
                    if(obj.getInt("count") != 0){
                        ...
                        //newAsset intnt1 = new newAsset();
                        //intnt1.syncSQLiteMySQLDB();


                    }else{
                        Toast.makeText(context, "Sync not needed", Toast.LENGTH_SHORT);
                    }
